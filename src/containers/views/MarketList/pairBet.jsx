...
const MarketList = (props) => {
  ...
  const unSelectRunners = (e, data, tr) => {
    ...
    if (e.target.checked == false) {
      ...
      fetch(
        import.meta.env.VITE_API_HOST + "/event/unSelectSingleRunner",
        requestOptions
      )
        .then((response) => {
          if (response.status === 403) {
                    ...
                    {confirmMarkets.includes(v.id) == false ? (
                                      ...
                                      >
                                        ...
                                        v.parent_locked == 0 ? (
                                          <input
                                            ...
                                            checked={autoSelect.includes(v1.id)}
                                        ...
                                        <span className="display-1 badge badge-info badge-pill ">
                                          {v1.name}
                                        </span>
                                      </li>
                                    </>
                      ...
                      <div className="container mt-4" key={k}>
                        <div className="row" key={k}>
                          <div className="col" key={k}>
                            <ul className="list-group">
                              <li className="list-group-item list-group-item-info bold">
                                Your Player Pairs
                              </li>
                                ...
                                v1.market_id == v.id && v1.type == "user" ? (
                                  <>
                                    <li className="list-group-item list-group-item-info d-flex align-items-center">
                                      ...
                                      <span className="ml-4 bold center">
                                        {v1.runner_name}
                                      </span>
                                      <span className="ml-4 bold center">
                                        {v1.team === 1
                                ...
                                v1.market_id == v.id && v1.type == "system" ? (
                                  <>
                                    <li className="list-group-item list-group-item-secondary d-flex justify-content-between align-items-center">
                                      <CheckIcon className="w-6 text-secondary"></CheckIcon>
                                      <i className="badge badge-secondary badge-pill">
                                        {v1.runner_name}
                                      </i>
                                    </li>
                                  </>
