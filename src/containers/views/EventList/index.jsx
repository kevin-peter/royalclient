      ...
      {eventList.length > 0 ? (
        <div className="row">
          {eventList.map(
            (v, k) =>
              v.parent_status === 1 &&
              moment(v.closedate).isAfter(moment(currDate)) && (
                <div className="col-12 col-md-5 p-0" key={k}>
                  <div className="card">
                    <div className="card-body">
                      {/* <h5 class="card-title">{v.results}</h5> */}
                      {/* <h5 class="card-title">{v.closedate}</h5> */}
                      ...
                      >
                        ...
                        <p className="card-text">
                          ...
                          {moment(v.closedate).format("DD/MM/YYYY HH:mm A")}
                        </p>
                      </NavLink>
