    ...
    return (
      <React.Fragment>
        ...
        <div className="font-semibold  text-sm">
          <h1 className="text-center text-light">-: Chip Summary :-</h1>
          <div className="overflow-auto">
            <table className="table table-bordered table-striped table-sm table-warning shadow kbr-table text-success">
              <thead className="">
                <tr>
          ...
          <div className="overflow-auto">
            <table className="table table-bordered table-striped table-sm table-warning shadow kbr-table text-danger">
              ...
              <tbody>
                ...
                {this.state.profile.up_line &&
                  this.state.profile.up_line < 0 && (
                    <tr className="text-black dark:text-danger bg-white">
                      <td className="text-center">#</td>
                      <td className="px-2 py-1">Parent P/L</td>
                      <td className="px-2 py-1 text-right">
                        <span role="button" className={`text-center`}>
                ...
                <tr className="text-danger">
                  ...
                  <td className="px-2 py-1 text-right">
                    <span role="button" className={`text-center total`}>
                      {/*this.state.n_total * (-1)*/ this.state.p_total}
                    </span>
                  </td>
                  <td></td>
                </tr>
